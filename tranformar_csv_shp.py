...
df_roubos_raw = pd.read_csv(
    r"C:\Users\Vivian - H2R\Downloads\mba\git\mba_arrumado\dados_tratados\dados_tratados\df_roubos_24_recort.csv",
    dtype={0: str}
)
...
output_path = "C:/Users/Vivian - H2R/Downloads/mba/git/mba_arrumado/h3df_roubos_6.shp"
